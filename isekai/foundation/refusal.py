...
-- never a zero, never a best-effort parse. It started in `isekai.evaluation.evaluate`
...
It is a pure move. `isekai.evaluation.evaluate` re-exports it, so both existing
importers keep resolving and no behaviour changes.
"""
