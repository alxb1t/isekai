...
def test_dispatch_selects_the_qwen_workflow() -> None:
...
def test_dispatch_selects_the_animagine_workflow() -> None:
...
def test_dispatch_exits_on_an_unknown_model() -> None:
    with pytest.raises(SystemExit):
        get_model("midjourney")


@pytest.mark.spec("model-registry:name-resolution:unknown-name-message-guides-the-user")
def test_dispatch_names_the_unknown_model_and_lists_the_valid_ones() -> None:
...
def test_dispatch_pairs_qwen_with_its_injection_adapter() -> None:
...
def test_dispatch_pairs_animagine_with_its_injection_adapter() -> None:
...
def test_dispatch_selects_the_animagine_i2i_workflow() -> None:
...
def test_dispatch_reuses_the_animagine_injector_for_img2img() -> None:
...
def test_dispatch_pairs_animagine_i2i_with_the_mutation_seam() -> None:
...
def test_dispatch_leaves_earlier_models_without_a_mutator() -> None:
...
def test_dispatch_selects_the_animagine_i2i_cn_workflow() -> None:
    assert (
...
def test_dispatch_reuses_the_animagine_injector_for_the_cn_path() -> None:
...
def test_dispatch_pairs_animagine_i2i_cn_with_the_mutation_seam() -> None:
