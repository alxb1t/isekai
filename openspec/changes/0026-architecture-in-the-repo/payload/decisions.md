...
- **Why:** D0 — and the sheet needs nothing a closed model offered: the router places 73–77% of the
...
(D15). The checkpoint and its digest belong to each flow.
...
- **Why:** the runs-root check (D18) and the choice of reader, tagger and transport happen in one place,
