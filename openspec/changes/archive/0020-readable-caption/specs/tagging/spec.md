...
behind. A filtered list answers a question he can already ask. Marking which tags a vocabulary contains
is a display concern and is not filtering — the surface may mark, and this stage may not drop.
