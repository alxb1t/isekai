...
- [ ] **T10e · operator picks** from the sheet at `prototype/out/qwen_path_sheet.png` — Lightning (a/b/c, flat cel) vs full (d–g, painterly)
- [ ] **T10f · all 10 portraits** at the chosen setting, as `notile` got in T6c — steps x cfg x Lightning, the lever F15 identified. The target sits between two settings already run
