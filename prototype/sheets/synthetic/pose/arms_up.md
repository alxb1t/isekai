# `arms_up` — criteria sheet

Drafted by a reader from `prototype/inputs/synthetic/pose/arms_up.png`, 2026-09-10. **Not reviewed.** ✓ marks a scored
criterion. Edit the table, then run `sheet.py build arms_up` to regenerate the prompt.
...
| 5 · hair silhouette ✓ | long hair, ponytail |
...
```
masterpiece, best quality, amazing quality, newest, 1girl, solo, brown hair, long hair, ponytail, brown eyes, tank top, grey shirt, black pants, leggings, barefoot, smile, closed mouth, looking at viewer, full body, small breasts, simple background, grey background, anime screencap, detailed eyes, soft lighting
```
