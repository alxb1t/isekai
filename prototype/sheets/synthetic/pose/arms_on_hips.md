# `arms_on_hips` — criteria sheet

Drafted by a reader from `prototype/inputs/synthetic/pose/arms_on_hips.png`, 2026-09-10. **Not reviewed.** ✓ marks a scored
criterion. Edit the table, then run `sheet.py build arms_on_hips` to regenerate the prompt.
...
| 5 · hair silhouette ✓ | long hair, wavy hair, sidelocks |
...
| 13 · pose ✓ | standing, hands on own hips |
...
```
masterpiece, best quality, amazing quality, newest, 1girl, solo, brown hair, long hair, wavy hair, sidelocks, blue eyes, red shirt, long sleeves, shirt, blue pants, denim, white footwear, smile, closed mouth, looking at viewer, standing, hands on own hips, full body, medium breasts, simple background, grey background, anime screencap, detailed eyes, soft lighting
```
