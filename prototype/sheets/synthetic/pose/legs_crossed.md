# `legs_crossed` — criteria sheet

Drafted by a reader from `prototype/inputs/synthetic/pose/legs_crossed.png`, 2026-09-10. **Not reviewed.** ✓ marks a scored
criterion. Edit the table, then run `sheet.py build legs_crossed` to regenerate the prompt.
...
| 5 · hair silhouette ✓ | long hair, wavy hair, parted bangs |
| 6 · eye colour ✓ | brown eyes |
| 7 · eyebrows | *(none)* |
| 8 · marks ✓ | *(none)* |
| 9 · clothes ✓ | grey shirt, shirt, short sleeves, black pants, leggings, barefoot |
| 10 · accessories | *(none)* |
| 11 · expression | closed mouth |
| 12 · gaze ✓ | looking at viewer |
| 13 · pose ✓ | sitting, indian style, crossed legs, on floor |
...
```
masterpiece, best quality, amazing quality, newest, 1girl, solo, brown hair, long hair, wavy hair, parted bangs, brown eyes, grey shirt, shirt, short sleeves, black pants, leggings, barefoot, closed mouth, looking at viewer, sitting, indian style, crossed legs, on floor, full body, medium breasts, simple background, grey background, anime screencap, detailed eyes, soft lighting
```
