# `05_01` — criteria sheet

Drafted by a reader from `prototype/inputs/synthetic/portfolio/05_01.png`, 2026-09-10. **Not reviewed.** ✓ marks a scored
criterion. Edit the table, then run `sheet.py build 05_01` to regenerate the prompt.
...
| 5 · hair silhouette ✓ | hair bun, messy hair, hair up |
| 6 · eye colour ✓ | brown eyes |
| 7 · eyebrows | thick eyebrows |
| 8 · marks ✓ | *(none)* |
| 9 · clothes ✓ | red jacket, jacket, formal, white shirt |
| 10 · accessories | glasses, hoop earrings, earrings |
...
```
masterpiece, best quality, amazing quality, newest, 1girl, solo, brown hair, hair bun, messy hair, hair up, brown eyes, thick eyebrows, red jacket, jacket, formal, white shirt, glasses, hoop earrings, earrings, closed mouth, looking at viewer, upper body, portrait, medium breasts, simple background, grey background, anime screencap, detailed eyes, soft lighting
```
